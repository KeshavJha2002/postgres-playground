+ I am using `Docker Image` to install postgres and run the container. The reason for it is quite simple. It is light weight and runs in am isolated enviroment.
